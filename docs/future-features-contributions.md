...
- Check the [Issues](https://github.com/mozilla-ai/speech-to-text-finetune/issues) page to see if there are feature requests you'd like to implement
- Refer to our [Contribution Guide](https://github.com/mozilla-ai/speech-to-text-finetune/blob/main/CONTRIBUTING.md) for more details on contributions
...
### 💡 **Share Your Ideas**
Got an idea for how this Blueprint could be improved? You can share your suggestions through [GitHub Discussions](https://github.com/mozilla-ai/speech-to-text-finetune/discussions).
